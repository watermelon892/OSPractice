...
void my_strncmp_test() {
  ...
  printf("## my_strncmp Test Start!!\n\n");

  printf("### arg1(12345) == arg2(12345), size=5\n");
  ret = my_strncmp("12345", "12345", 5);
  printf("Value: %d\n", ret);
  check(ret == 0);

  printf("### arg1(12346) > arg2(12345), size=5\n");
  ret = my_strncmp("12346", "12345", 5);
  printf("Value: %d\n", ret);
  check(ret == 1);

  printf("### arg1(12345) < arg2(12346), size=5\n");
  ret = my_strncmp("12345", "12346", 5);
  printf("Value: %d\n", ret);
  check(ret == -1);

  printf("### arg1(123450) == arg2(12345), size=5\n");
  ret = my_strncmp("123450", "12345", 5);
  printf("Value: %d\n", ret);
  check(ret == 0);

  printf("### arg1(12345) == arg2(123450), size=5\n");
  ret = my_strncmp("12345", "123450", 5);
  printf("Value: %d\n", ret);
  check(ret == 0);
